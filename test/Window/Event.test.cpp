...
struct Visitor
{
    bool operator()(const sf::Event::Closed&)
    {
        return true;
    }
...
TEST_CASE("[Window] sf::Event")
{
    ...
    SECTION("getVariant()")
    {
        ...
        CHECK(std::visit(Visitor{}, event.getVariant()));
    }
}
